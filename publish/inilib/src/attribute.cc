...
//
// $Id: attribute.cc,v 1.13 2005/03/10 18:13:12 bwbarrett Exp $
//
...
// Argh... Without this, the code:
//
//  attribute = "hi"
//
// will have the bool version (above) called instead of the string
// version.  But the casting operator is NOT needed and will result in
// a ambiguity error from the compiler...
INI::attribute&
INI::attribute::operator=(const char *new_value)
{
  debug << "*** Entering attribute::operator=(const char*) ***" << std::endl;
