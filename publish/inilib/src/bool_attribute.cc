...
//
// $Id: bool_attribute.cc,v 1.7 2002/05/09 18:51:21 bwbarrett Exp $
//
...
INI::attribute&
INI::bool_attribute::operator=(const char *new_value)
{
  debug << "*** Entering boolattribute::operator=(char*) ***" << std::endl;
